export type DetailedSection=[string,string[]];
export const articleContent:Record<string,DetailedSection[]>={
...
"A toxina botulínica reduz temporariamente a contração dos músculos onde é aplicada. Nas indicações estéticas, isso suaviza as rugas dinâmicas, aquelas que aparecem com o movimento, como as linhas da testa, entre as sobrancelhas e ao redor dos olhos.",
"Rugas presentes mesmo com o rosto em repouso, flacidez e alterações de volume não respondem à toxina. Cada queixa tem a sua ferramenta, e parte importante da consulta é explicar o que a toxina pode e o que não pode tratar.",
"Além das rugas, a toxina tem outras indicações dermatológicas avaliadas em consulta, como o controle da sudorese excessiva em áreas específicas."
]],
["O que é avaliado antes da aplicação",[
"O médico examina a anatomia do rosto em repouso e em movimento: força e padrão de contração dos músculos, assimetrias naturais, posição das sobrancelhas e características que mudam o planejamento dos pontos.",
"O histórico de saúde também importa: doenças neuromusculares, gestação, amamentação, medicamentos em uso e reações a aplicações anteriores devem ser informados, pois influenciam a indicação.",
"O alinhamento de expectativas fecha a avaliação. O objetivo descrito na consulta é suavizar a expressão preservando a naturalidade, e não imobilizar o rosto. Resultados variam de pessoa para pessoa."
]],
["Como é a aplicação",[
"O procedimento é realizado em consultório e costuma durar poucos minutos. Após a definição dos pontos planejados, a aplicação é feita com agulhas muito finas; o desconforto tende a ser pequeno e passageiro.",
"O efeito não é imediato: instala-se ao longo dos primeiros dias e é avaliado por completo algumas semanas depois, quando um retorno pode ajustar pontos específicos, se necessário.",
"Nas primeiras horas, orientações simples, como não massagear a área, ajudam o produto a permanecer onde foi planejado. As recomendações específicas são entregues no dia."
]],
["Efeito, duração e reavaliação",[
"A duração do efeito varia entre pessoas, conforme o metabolismo, a musculatura e a área tratada: em geral, alguns meses. Com o tempo, o movimento retorna gradualmente.",
"Novas aplicações seguem intervalos definidos pelo médico. Repetições muito frequentes não são recomendadas, e o plano pode mudar ao longo dos anos conforme o rosto e os objetivos mudam.",
"A aplicação de toxina botulínica é ato médico. Verificar o registro do profissional, o ambiente e a procedência do produto faz parte da segurança do procedimento, e perguntas sobre isso são sempre legítimas na consulta."
]]],
...
["Os tipos mais frequentes de marca de nascimento",[
"As marcas de nascimento se dividem, de forma geral, em dois grupos: as vasculares, formadas por vasos sanguíneos, como manchas planas rosadas e hemangiomas, e as pigmentadas, como os nevos congênitos (pintas presentes ao nascer) e manchas acastanhadas.",
"A maioria é benigna e exige apenas observação. Muitas manchas vasculares planas do recém-nascido, comuns na nuca e nas pálpebras, clareiam espontaneamente nos primeiros anos.",
"Cada tipo tem comportamento próprio: algumas marcas permanecem estáveis a vida toda, outras crescem com a criança e algumas regridem sozinhas. Identificar corretamente o tipo é o que define a conduta."
]],
["O que os pais devem observar",[
"Crescimento rápido, mudança de cor, sangramento, formação de ferida e incômodo persistente são os sinais que mudam a conduta e antecipam a consulta.",
"Fotografias com boa luz, feitas periodicamente ao lado de uma referência de tamanho, como uma moeda, ajudam o médico a avaliar a evolução real da marca entre as consultas.",
"Marcas em locais de atrito, como a área da fralda, e marcas extensas em qualquer localização merecem avaliação desde cedo, mesmo sem sinais de alarme."
]],
["Hemangiomas: por que o tempo importa",[
"O hemangioma infantil é um tumor vascular benigno que pode ser quase invisível ao nascimento e crescer rapidamente nas primeiras semanas de vida. A fase de crescimento é justamente a janela em que a avaliação faz mais diferença.",
"Hemangiomas perto dos olhos, do nariz, da boca ou na área da fralda, os muito volumosos e os que formam feridas têm indicação de avaliação precoce; o tratamento, quando indicado, é mais eficaz quando começa cedo.",
"Muitos hemangiomas pequenos e em áreas sem risco apenas são acompanhados, pois regridem espontaneamente ao longo dos anos. A decisão entre observar e tratar é individual."
]],
["Pintas congênitas e o acompanhamento ao longo da vida",[
"Nevos congênitos são acompanhados conforme o tamanho e as características: os pequenos, na grande maioria, exigem apenas observação periódica; os maiores pedem seguimento mais próximo desde o início.",
"O exame dermatológico, com dermatoscopia quando indicada, avalia padrões que não são visíveis a olho nu e define o intervalo adequado entre as revisões.",
"Ensinar a criança, com naturalidade, a conhecer as próprias pintas prepara o adolescente para observar mudanças no futuro. O acompanhamento é uma rotina de cuidado, não um motivo de alarme."
]]],
"acne-tratamento-por-fases":[
["Acne em cada fase da vida",[
"Na adolescência, a acne acompanha o aumento da oleosidade da puberdade e costuma se concentrar no rosto, com cravos e espinhas. É a apresentação mais conhecida, mas não é a única.",
"No adulto, especialmente em mulheres, a acne tende a se localizar na parte inferior do rosto e no pescoço, com lesões mais inflamadas e persistentes, muitas vezes com piora cíclica relacionada ao período menstrual.",
"Também existe a acne que retorna anos depois de resolvida e a que aparece pela primeira vez na vida adulta. Cada padrão sugere mecanismos diferentes, e por isso o tratamento não é o mesmo para todos."
]],
["O que o dermatologista investiga",[
"A consulta avalia o padrão e a distribuição das lesões, o tempo de evolução, os ciclos de piora e o que já foi tentado. Medicamentos em uso, suplementos e cosméticos entram na conversa, pois alguns pioram a acne.",
"Em mulheres adultas com piora cíclica, irregularidade menstrual ou outros sinais de alteração hormonal, exames podem ser indicados para investigar condições associadas.",
"A pele também é avaliada como um todo: oleosidade, sensibilidade, manchas e cicatrizes já presentes influenciam a escolha dos produtos e a ordem das etapas do tratamento."
]],
["Como o tratamento é construído",[
"A base são os cuidados diários adequados: higiene suave, hidratante não comedogênico e protetor solar, inclusive para reduzir as manchas que ficam depois das lesões.",
"Sobre essa base entram os medicamentos: tópicos nos quadros mais leves, orais nos moderados a graves, sempre prescritos conforme o perfil de cada paciente. Gestação e planejamento reprodutivo mudam as opções e devem ser informados.",
"A resposta é avaliada ao longo de semanas a meses, com ajustes nos retornos. Trocar de produto a cada quinze dias, por conta própria, é uma das causas mais comuns de frustração com o tratamento."
]],
["Marcas, manchas e o fator tempo",[
"A inflamação repetida é o que gera manchas e cicatrizes. Por isso o momento de tratar é agora, não depois que as marcas aparecerem.",
"Manchas escuras pós-inflamatórias tendem a melhorar com fotoproteção e clareadores; cicatrizes deprimidas ou elevadas exigem procedimentos específicos, planejados depois que a acne está controlada.",
"Espremer lesões aumenta diretamente o risco de marcas. Se uma lesão isolada incomoda muito, a drenagem em consultório é o caminho seguro."
]]],
...
"É uma inflamação crônica das áreas com mais glândulas sebáceas: couro cabeludo, sobrancelhas, cantos do nariz, orelhas e, às vezes, o centro do peito. No couro cabeludo, aparece como descamação com coceira, a popular caspa.",
"Não é contagiosa e não indica falta de higiene. Existe uma reatividade individual da pele, com participação da oleosidade e de leveduras que normalmente habitam a pele de todos nós.",
"O curso é de crises e melhoras. Clima seco ou frio, estresse e alguns produtos podem disparar as crises; o padrão varia entre pessoas."
]],
["Por que ela volta",[
"A predisposição individual não desaparece com o tratamento: o que o cuidado faz é controlar a inflamação e alongar os períodos de calma. Recaídas eventuais fazem parte do comportamento da doença.",
"Lavar menos o cabelo para 'proteger' costuma piorar o quadro, porque o acúmulo de oleosidade alimenta o ciclo. A frequência ideal de lavagem é individual e faz parte da orientação em consulta.",
"Interromper o tratamento assim que a descamação some, e retomar apenas na crise seguinte, mantém o ciclo. Esquemas de manutenção reduzem a frequência das recaídas."
]],
["Como se trata",[
"Xampus com ativos específicos são a base do tratamento no couro cabeludo, usados em esquema de ataque e depois de manutenção. A técnica importa: tempo de contato e frequência fazem diferença.",
"Nas crises mais intensas, medicamentos tópicos anti-inflamatórios podem ser associados por períodos definidos, conforme prescrição.",
"Quando há acometimento do rosto, os produtos são diferentes dos do couro cabeludo: a pele facial pede veículos e concentrações próprios."
]],
["Quando investigar além da caspa",[
"Placas muito espessas e aderidas podem indicar psoríase do couro cabeludo, que se trata de forma diferente. A tricoscopia ajuda a diferenciar.",
"Queda de cabelo associada à descamação merece exame dedicado: a dermatite seborreica em si não costuma causar queda importante, e a associação pode indicar outra condição em paralelo.",
"Falta de resposta ao tratamento bem conduzido é motivo de reavaliação diagnóstica, não de doses maiores por conta própria."
]]],
...
"O exame complementa a consulta dermatológica, mas não a substitui. A avaliação clínica continua sendo o centro da vigilância das pintas."
]],
...
"O cisto epidérmico é uma bolsa revestida por pele que acumula queratina, o material esbranquiçado que às vezes drena. Cresce devagar e pode inflamar de tempos em tempos.",
"O lipoma é um acúmulo benigno de células de gordura sob a pele: um nódulo macio, móvel, geralmente indolor, mais comum no tronco, nos ombros e nos braços.",
"Ambos são frequentes e benignos. A avaliação médica confirma o diagnóstico, em geral clínico, e diferencia esses nódulos de outras lesões que merecem investigação."
]],
["Quando a remoção vale a pena",[
"Crescimento progressivo, dor, inflamações repetidas do cisto, incômodo com roupas e movimentos, e dúvida diagnóstica são as principais razões para operar.",
"Cisto que já inflamou tende a inflamar de novo, e cada episódio inflama também a área ao redor, tornando a cirurgia futura um pouco mais trabalhosa. Remover no intervalo entre crises é o momento ideal.",
"A motivação estética também é legítima e é discutida com franqueza: localização, tamanho e cicatriz esperada entram na equação."
]],
["Como é a cirurgia",[
"O procedimento é ambulatorial, com anestesia local. No cisto, a remoção inclui a cápsula inteira: deixá-la para trás é o que permite o retorno da lesão.",
"No lipoma, a retirada é feita por incisão planejada conforme o tamanho e a profundidade. O fechamento busca a melhor cicatriz possível para a região.",
"O material removido pode ser enviado para análise histopatológica, que confirma o diagnóstico com segurança."
]],
["Recuperação e sinais de atenção",[
"Curativos simples, restrição breve de esforço sobre a área e retirada de pontos em consulta compõem o pós-operatório típico. As orientações são entregues por escrito.",
"Espremer cisto em casa não o remove (a cápsula permanece) e frequentemente causa infecção e cicatriz pior. Se inflamar, o caminho é a consulta, não a pressão.",
"Nódulos endurecidos, fixos, de crescimento rápido ou que reaparecem após remoção completa fogem do padrão benigno e exigem investigação adicional."
]]],
"verrugas-tratamento":[
["O que são verrugas",[
