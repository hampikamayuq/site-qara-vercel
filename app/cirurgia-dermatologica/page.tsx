...
export default function SurgeryPage() {
  return <><script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(schema)}}/><script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(faqSchema)}}/><Header current="/cirurgia-dermatologica" /><main id="conteudo">
    <section className="specialty-hero specialty-hero-dark" data-conversion-event="specialty_view" data-conversion-placement="hero" data-conversion-context="specialty" data-conversion-specialty="cirurgia-dermatologica"><Breadcrumb trail={[["Cirurgia dermatológica", ""]]}>Cirurgia dermatológica</Breadcrumb><div className="shell specialty-hero-grid"><div><p className="kicker light">Cirurgia dermatológica · Copacabana</p><h1>Avaliação, retirada de lesões e reconstrução da pele.</h1><p className="lead">Biópsias e cirurgias da pele, do couro cabeludo e das unhas, com planejamento e acompanhamento da cicatrização.</p><div className="actions"><a className="button button-light" href={appointmentLinks.diego} data-conversion-event="whatsapp_click" data-conversion-placement="hero" data-conversion-variant="schedule" data-conversion-context="specialty" data-conversion-specialty="cirurgia-dermatologica">Consultar horários</a><a className="button button-outline-light" href="#procedimentos">Ver procedimentos realizados</a></div></div><div className="specialty-portrait"><img src="/images/dr-diego.webp" srcSet="/images/dr-diego-640.webp 640w, /images/dr-diego-1024.webp 1024w, /images/dr-diego.webp 1351w" sizes="(max-width: 900px) 100vw, 45vw" alt="Dr. Diego Gálvez, dermatologista e cirurgião dermatológico" width={1351} height={1672} fetchPriority="high" /></div></div></section>
    ...
    <CtaBand whatsappUrl={appointmentLinks.diego} />
  </main><Footer /></>;
}
