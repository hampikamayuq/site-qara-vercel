...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = ["", "/dermatologia-clinica", "/cirurgia-dermatologica", "/cancer-de-pele", "/cirurgia-controle-de-margens", "/biopsia", "/cabelo", "/unhas", "/doencas-inflamatorias", "/dermatopediatria", "/dermatologia-estetica", "/psoriase", "/hidradenite", "/vitiligo", "/dermatite-atopica", "/en", "/es", "/equipe", "/equipe/dr-diego-galvez", "/equipe/dr-miguel-ceccarelli", "/equipe/dra-diana-stohmann", "/equipe/dra-manuela-pedretti", "/equipe/dr-fabricio-de-andrade", "/blog"];
